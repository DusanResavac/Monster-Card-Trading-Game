...
public class CardTest {
    ...
    public void testEquals_SC_Kraken () {
        ...
        //"mctg.SpellCard shouldn't be equal to mctg.Kraken"
        assertFalse(sc.equals(kraken));
    }

    @Test
    @DisplayName("Cards equal | mctg.SpellCard, mctg.Wizard")
    public void testEquals_SC_Wizard () {
        Card sc = new SpellCard (50, Element.FIRE);
        MonsterCard wizard = new Wizard(40, Element.NORMAL);

        //"mctg.SpellCard shouldn't be equal to mctg.Wizard"
        assertFalse(sc.equals(wizard));
    }

    @Test
    @DisplayName("Cards equal | mctg.Kraken, mctg.Wizard")
    public void testEquals_Kraken_Wizard () {
        ...
        //"mctg.Kraken shouldn't be equal to mctg.Wizard"
        assertFalse(kraken.equals(wizard));
    }

    @Test
    @DisplayName("Cards equal | mctg.Dragon-Fire, mctg.Dragon-Water")
